...
def requestDataIp(stringRequest):
    ...
    #print(binario_first_host)
    aux_bit_host = bit_host
    binario_broadcast = string_binario[0:int(cidr)]
    while aux_bit_host > 0:
        binario_broadcast = binario_broadcast + "1"
        aux_bit_host = aux_bit_host - 1
    #print(binario_broadcast)
    binario_last_host = binario_broadcast[0:31]
    binario_last_host = binario_last_host + "0"
    #print(binario_last_host)
    #print("********")
    #print(stringBinarioToFormatIp(string_binario))
    #print(stringBinarioToFormatIp(binario_red))
    #print(stringBinarioToFormatIp(binario_first_host))
    #print(stringBinarioToFormatIp(binario_last_host))
    #print(stringBinarioToFormatIp(binario_broadcast))
